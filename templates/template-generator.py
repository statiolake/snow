...
hexred__lt = tohex( gold(1.59) , gold(1.31) , hue_red_ )
hexgold_lt = tohex( gold(1.50) , gold(1.38) , hue_gold )
hexgren_lt = tohex( gold(1.53) , gold(1.50) , hue_gren )
hexcyan_lt = tohex( gold(1.56) , gold(1.56) , hue_cyan )
hexblue_lt = tohex( gold(1.59) , gold(1.31) , hue_blue )
hexmgnt_lt = tohex( gold(1.59) , gold(1.44) , hue_mgnt )

hexred__dk = tohex( gold(1.00) , gold(2.62) , hue_red_ )
hexgold_dk = tohex( gold(0.91) , gold(2.75) , hue_gold )
