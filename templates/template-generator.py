...
hexblue_lt = tohex( gold(1.46) , gold(1.31) , hue_blue )
hexmgnt_lt = tohex( gold(1.42) , gold(1.38) , hue_mgnt )
...
hexblue_dk = tohex( gold(0.96) , gold(2.62) , hue_blue )
hexmgnt_dk = tohex( gold(0.92) , gold(2.75) , hue_mgnt )
