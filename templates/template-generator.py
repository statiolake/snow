...
cro_ltacnt = phic(0.88)
cro_dkacnt = phic(1.75)

hexgry0_lt = tohex( phic(0.03) , phic(7.88) , hue_blue )
hexgry1_lt = tohex( phic(0.18) , phic(5.94) , hue_blue )
hexgry2_lt = tohex( phic(1.50) , phic(4.00) , hue_blue )
hexgry3_lt = tohex( phic(2.09) , phic(4.62) , hue_blue )

hexgry0_dk = tohex( phic(3.43) , phic(5.25) , hue_blue )
hexgry1_dk = tohex( phic(2.92) , phic(4.62) , hue_blue )
hexgry2_dk = tohex( phic(1.00) , phic(4.00) , hue_blue )
hexgry3_dk = tohex( phic(0.58) , phic(4.62) , hue_blue )

hexred__lt = tohex( phic(1.47) , cro_ltacnt , hue_red_ )
hexgold_lt = tohex( phic(1.48) , cro_ltacnt , hue_gold )
hexgren_lt = tohex( phic(1.51) , cro_ltacnt , hue_gren )
hexcyan_lt = tohex( phic(1.69) , cro_ltacnt , hue_cyan )
hexblue_lt = tohex( phic(1.65) , cro_ltacnt , hue_blue )
hexmgnt_lt = tohex( phic(1.50) , cro_ltacnt , hue_mgnt )

hexred__dk = tohex( phic(0.99) , cro_dkacnt , hue_red_ )
hexgold_dk = tohex( phic(0.98) , cro_dkacnt , hue_gold )
