...
hexred__lt = tohex( gold(1.38) , gold(1.25) , hue_red_ )
hexgold_lt = tohex( gold(1.31) , gold(1.38) , hue_gold )
hexgren_lt = tohex( gold(1.38) , gold(1.50) , hue_gren )
hexcyan_lt = tohex( gold(1.38) , gold(1.56) , hue_cyan )
hexblue_lt = tohex( gold(1.38) , gold(1.31) , hue_blue )
hexmgnt_lt = tohex( gold(1.38) , gold(1.44) , hue_mgnt )

hexred__dk = tohex( gold(1.00) , gold(2.38) , hue_red_ )
hexgold_dk = tohex( gold(0.94) , gold(2.50) , hue_gold )
hexgren_dk = tohex( gold(1.00) , gold(3.00) , hue_gren )
hexcyan_dk = tohex( gold(1.00) , gold(3.12) , hue_cyan )
