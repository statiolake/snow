...
hexgry1_lt = tohex( phic(0.14) , phic(6.50) , hue_blue )
...
hexgry3_dk = tohex( phic(0.59) , phic(4.50) , hue_blue )

hexred__lt = tohex( phic(1.46) , cro_ltacnt , hue_red_ )
hexgold_lt = tohex( phic(1.46) , cro_ltacnt , hue_gold )
hexgren_lt = tohex( phic(1.54) , cro_ltacnt , hue_gren )
hexcyan_lt = tohex( phic(1.71) , cro_ltacnt , hue_cyan )
hexblue_lt = tohex( phic(1.79) , cro_ltacnt , hue_blue )
hexmgnt_lt = tohex( phic(1.54) , cro_ltacnt , hue_mgnt )
...
hexcyan_dk = tohex( phic(0.96) , cro_dkacnt , hue_cyan )
hexblue_dk = tohex( phic(1.00) , cro_dkacnt , hue_blue )
hexmgnt_dk = tohex( phic(0.98) , cro_dkacnt , hue_mgnt )
