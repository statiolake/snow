...
hexgry0_lt = tohex( phic(0.02) , phic(7.88) , hue_blue )
hexgry1_lt = tohex( phic(0.17) , phic(6.39) , hue_blue )
hexgry2_lt = tohex( phic(1.48) , phic(4.00) , hue_blue )
hexgry3_lt = tohex( phic(2.12) , phic(4.29) , hue_blue )

hexgry0_dk = tohex( phic(3.48) , phic(5.25) , hue_blue )
hexgry1_dk = tohex( phic(2.96) , phic(4.77) , hue_blue )
hexgry2_dk = tohex( phic(1.01) , phic(4.00) , hue_blue )
hexgry3_dk = tohex( phic(0.55) , phic(4.29) , hue_blue )
...
hexcyan_lt = tohex( phic(1.75) , cro_ltacnt , hue_cyan )
hexblue_lt = tohex( phic(1.88) , cro_ltacnt , hue_blue )
hexmgnt_lt = tohex( phic(1.62) , cro_ltacnt , hue_mgnt )
...
hexmgnt_dk = tohex( phic(0.94) , cro_dkacnt , hue_mgnt )
