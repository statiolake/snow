...
hexred__lt = tohex( gold(1.56) , gold(1.25) , hue_red_ )
hexgold_lt = tohex( gold(1.50) , gold(1.38) , hue_gold )
hexgren_lt = tohex( gold(1.56) , gold(1.50) , hue_gren )
hexcyan_lt = tohex( gold(1.56) , gold(1.56) , hue_cyan )
hexblue_lt = tohex( gold(1.56) , gold(1.25) , hue_blue )
hexmgnt_lt = tohex( gold(1.56) , gold(1.44) , hue_mgnt )
