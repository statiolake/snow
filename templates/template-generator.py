...
hexgry0_dk = tohex( phic(3.48) , phic(5.50) , hue_blue )
hexgry1_dk = tohex( phic(2.96) , phic(4.75) , hue_blue )
...
hexblue_lt = tohex( phic(1.63) , cro_ltacnt , hue_blue )
hexmgnt_lt = tohex( phic(1.46) , cro_ltacnt , hue_mgnt )

hexred__dk = tohex( phic(1.00) , cro_dkacnt , hue_red_ )
hexgold_dk = tohex( phic(0.66) , cro_dkacnt , hue_gold )
hexgren_dk = tohex( phic(0.88) , cro_dkacnt , hue_gren )
hexcyan_dk = tohex( phic(0.97) , cro_dkacnt , hue_cyan )
hexblue_dk = tohex( phic(1.00) , cro_dkacnt , hue_blue )
hexmgnt_dk = tohex( phic(0.91) , cro_dkacnt , hue_mgnt )
