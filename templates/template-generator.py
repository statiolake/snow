...
hexcyan_lt = tohex( gold(1.47) , gold(1.53) , hue_cyan )
hexblue_lt = tohex( gold(1.47) , gold(1.34) , hue_blue )
hexmgnt_lt = tohex( gold(1.44) , gold(1.41) , hue_mgnt )
...
hexcyan_dk = tohex( gold(0.97) , gold(3.06) , hue_cyan )
hexblue_dk = tohex( gold(0.97) , gold(2.69) , hue_blue )
hexmgnt_dk = tohex( gold(0.94) , gold(2.81) , hue_mgnt )
