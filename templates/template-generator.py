...
cro_ltacnt = phic(0.81)
cro_dkacnt = phic(1.62)

hexgry0_lt = tohex( phic(0.00) , phic(9999) , hue_blue )
hexgry1_lt = tohex( phic(0.16) , phic(6.50) , hue_blue )
hexgry2_lt = tohex( phic(1.46) , phic(4.00) , hue_blue )
hexgry3_lt = tohex( phic(2.09) , phic(4.25) , hue_blue )

hexgry0_dk = tohex( phic(3.50) , phic(5.50) , hue_blue )
hexgry1_dk = tohex( phic(2.98) , phic(4.75) , hue_blue )
hexgry2_dk = tohex( phic(1.02) , phic(4.00) , hue_blue )
hexgry3_dk = tohex( phic(0.56) , phic(4.25) , hue_blue )

hexred__lt = tohex( phic(1.42) , cro_ltacnt , hue_red_ )
hexgold_lt = tohex( phic(1.44) , cro_ltacnt , hue_gold )
hexgren_lt = tohex( phic(1.47) , cro_ltacnt , hue_gren )
hexcyan_lt = tohex( phic(1.67) , cro_ltacnt , hue_cyan )
hexblue_lt = tohex( phic(1.61) , cro_ltacnt , hue_blue )
hexmgnt_lt = tohex( phic(1.46) , cro_ltacnt , hue_mgnt )

hexred__dk = tohex( phic(0.94) , cro_dkacnt , hue_red_ )
hexgold_dk = tohex( phic(0.75) , cro_dkacnt , hue_gold )
hexgren_dk = tohex( phic(0.88) , cro_dkacnt , hue_gren )
hexcyan_dk = tohex( phic(0.94) , cro_dkacnt , hue_cyan )
hexblue_dk = tohex( phic(0.94) , cro_dkacnt , hue_blue )
hexmgnt_dk = tohex( phic(0.88) , cro_dkacnt , hue_mgnt )
