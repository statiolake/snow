...
hexred__lt = tohex( gold(1.51) , gold(1.25) , hue_red_ )
hexgold_lt = tohex( gold(1.49) , gold(1.38) , hue_gold )
hexgren_lt = tohex( gold(1.49) , gold(1.56) , hue_gren )
hexcyan_lt = tohex( gold(1.49) , gold(1.62) , hue_cyan )
hexblue_lt = tohex( gold(1.51) , gold(1.50) , hue_blue )
hexmgnt_lt = tohex( gold(1.51) , gold(1.50) , hue_mgnt )

hexred__dk = tohex( gold(1.03) , gold(2.50) , hue_red_ )
hexgold_dk = tohex( gold(0.97) , gold(2.75) , hue_gold )
hexgren_dk = tohex( gold(0.97) , gold(3.12) , hue_gren )
hexcyan_dk = tohex( gold(0.97) , gold(3.25) , hue_cyan )
hexblue_dk = tohex( gold(1.03) , gold(3.00) , hue_blue )
hexmgnt_dk = tohex( gold(1.03) , gold(3.00) , hue_mgnt )
