...
primary colors (of the standard additive model: red, green, blue) are assigned to "regular" elements,<br>
...
###### ☉ snow meets the 4.5:1 W3C [contrast ratio standard](https://www.w3.org/TR/UNDERSTANDING-WCAG20/visual-audio-contrast-contrast.html#visual-audio-contrast-contrast-73-head), except for cursorline/column highlighting (which meets the ISO 3:1 standard)
